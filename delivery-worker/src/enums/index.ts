// ----- Simulator entity state enums (must stay in sync with delivery-api) -----
...
// ----- Workflow plumbing names -----

export enum WorkflowTaskQueues {
  DISPATCH_TASK_QUEUE = 'DISPATCH_TASK_QUEUE',
}

export enum WorkflowNames {
  DISPATCH_ORDER_WORKFLOW = 'DispatchOrderWorkflow',
}

export enum WorkflowSignals {
  RESPOND_TO_OFFER = 'respondToOffer',
}

export enum WorkflowQueries {
  STATUS = 'status',
}
